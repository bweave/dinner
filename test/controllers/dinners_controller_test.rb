...
class DinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinner" do
    assert_difference("Dinner.count") do
      post dinners_url, params: { dinner: { last_suggested_at: @dinner.last_suggested_at, name: @dinner.name } }
    end
  ...
  test "should update dinner" do
    patch dinner_url(@dinner), params: { dinner: { last_suggested_at: @dinner.last_suggested_at, name: @dinner.name } }
